...
function onResultsPose(results) {
  ...
  drawLandmarks(
      ...
      const angleLeft = calculateAngle(
        results.poseLandmarks[pose.PoseLandmark.LEFT_SHOULDER],
        results.poseLandmarks[pose.PoseLandmark.LEFT_ELBOW],
        results.poseLandmarks[pose.PoseLandmark.LEFT_WRIST]
      );
      const angleRight = calculateAngle(
        results.poseLandmarks[pose.PoseLandmark.RIGHT_SHOULDER],
        results.poseLandmarks[pose.PoseLandmark.RIGHT_ELBOW],
        results.poseLandmarks[pose.PoseLandmark.RIGHT_WRIST]
      );
